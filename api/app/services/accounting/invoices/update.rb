  ...
  module Invoices
    class Update
      class << self
        ...
        def call(invoice_id, company, client, project, project_version, invoice_items, issue_date = Time.current)
          new_draft_invoice = ActiveRecord::Base.transaction do
            ...
            new_draft_invoice = create_new_draft_invoice!(company, client, project, project_version, invoice_items, issue_date)
        ...
        def create_new_draft_invoice!(company, client, project, project_version, invoice_items, issue_date)
          result = Invoices::Create.call(company, client, project, project_version, invoice_items, issue_date)
