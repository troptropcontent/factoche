...
module Accounting
  module FinancialTransactions
    ...
    RSpec.describe CreateCompletionSnapshotInvoice do
      describe '.call' do
        ...
        before do
          ...
          result = described_class.call(company, client, project_version, previous_items_invoice)
        ...
        context 'when successful' do
          ...
          it 'creates a draft completion snapshot invoice', :aggregate_failures do
            expect(result.data).to be_a(CompletionSnapshotInvoice)
        ...
        context 'when there is an error' do
          before do
            allow(CompletionSnapshotInvoice).to receive(:create!).and_raise(ActiveRecord::RecordInvalid)
          end
