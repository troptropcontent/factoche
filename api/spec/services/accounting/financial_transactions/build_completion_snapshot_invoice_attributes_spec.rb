...
module Accounting
  module FinancialTransactions
    RSpec.describe BuildCompletionSnapshotInvoiceAttributes do
      describe '.call' do
        ...
        before do
          ...
          result = CreateCompletionSnapshotInvoice.call(company, client, project_version, previous_items_invoice, 2.days.ago)
