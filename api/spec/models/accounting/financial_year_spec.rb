  ...
  describe 'validations' do
    ...
    describe '#dates_consistency' do
      it 'is valid when end_date is after start_date' do
        financial_year = FactoryBot.build(:accounting_financial_year,
    ...
    describe '#no_overlapping_exercises' do
      ...
      let!(:existing_fy) { FactoryBot.create(:accounting_financial_year,
                                            company_id: company.id,
                                            start_date: Date.new(2024, 1, 1),
                                            end_date: Date.new(2024, 12, 31)) }

      it 'allows non-overlapping financial years for same company' do
        new_fy = FactoryBot.build(:accounting_financial_year,
                                 company_id: company.id,
