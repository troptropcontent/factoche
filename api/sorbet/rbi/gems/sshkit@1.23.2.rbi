...
class SSHKit::Backend::Abstract
  ...
  # source://kamal/2.3.0/lib/kamal/sshkit_with_ext.rb#13
  def capture_with_debug(*args, **kwargs); end

  # source://kamal/2.3.0/lib/kamal/sshkit_with_ext.rb#9
  def capture_with_info(*args, **kwargs); end

  # source://kamal/2.3.0/lib/kamal/sshkit_with_ext.rb#17
  ...
  # source://kamal/2.3.0/lib/kamal/sshkit_with_ext.rb#21
  ...
  # source://kamal/2.3.0/lib/kamal/sshkit_with_ext.rb#36
...
class SSHKit::Backend::Netssh < ::SSHKit::Backend::Abstract
  ...
  # source://kamal/2.3.0/lib/kamal/sshkit_with_ext.rb#83
  ...
  class << self
    ...
    # @yield [config]
    #
    # source://kamal/2.3.0/lib/kamal/sshkit_with_ext.rb#68
...
class SSHKit::Backend::Netssh::Configuration
  ...
  # source://kamal/2.3.0/lib/kamal/sshkit_with_ext.rb#61
...
class SSHKit::Runner::Parallel < ::SSHKit::Runner::Abstract
  # source://kamal/2.3.0/lib/kamal/sshkit_with_ext.rb#115
  def execute; end
end
