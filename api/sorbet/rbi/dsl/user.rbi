...
class User
  ...
  module GeneratedAssociationMethods
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :companies, through: :members`.
    # 🔗 [Rails guide for `has_many_through` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-through-association)
    sig { returns(::Organization::Company::PrivateCollectionProxy) }
    def companies; end

    sig { params(value: T::Enumerable[::Organization::Company]).void }
    ...
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :members`.
