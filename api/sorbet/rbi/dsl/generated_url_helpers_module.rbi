...
module GeneratedUrlHelpersModule
  ...
  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_client_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_companies_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_company_clients_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_company_project_completion_snapshots_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_company_project_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_company_project_version_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_company_project_versions_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_company_projects_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_company_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_completion_snapshot_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_organization_completion_snapshots_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def invoice_api_v1_organization_completion_snapshot_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def previous_api_v1_organization_completion_snapshot_url(*args); end
